		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#SupplierDashboard-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SupplierDashboard-display": {
								"semanticObject": "SupplierDashboard",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.supplierdash",
									"url": sap.ui.require.toUrl("ns/supplierdash")
								}
							}
						}
					}
